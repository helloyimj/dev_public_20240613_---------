...
header +=                                '</div>';
header +=                                '<script>';
header +=                                'function fntopFlag() {';
header +=                                    '$("#top_flag").toggleClass("on");';
header +=                                    'var $topid = $("#chk_nuri");';
header +=                                    'var $srEl = $("#top_flag").find(".sr_only");';
header +=                                    'if ($topid.css("display") === "none" || $topid.css("display") === "") {';
header +=                                        '$topid.css("display", "block");';
header +=                                        '$srEl.text("닫힘");';
header +=                                    '} else {';
header +=                                        '$topid.css("display", "none");';
header +=                                        '$srEl.text("열림");';
header +=                                    '}';
header +=                                '}';
header +=                                '</script>';
...
header +=                                        '</li>';
header +=                                        '<li class="depth02_item">';
header +=                                            '<a href="04_개방서비스_안전_전화권유판매 수신거부의사 등록시스템.html" target="_self" class="depth02_item_anchor" title="개방서비스 안전 카테고리 소개 페이지로 이동">안전</a>';
header +=                                        '</li>';
header +=                                        '<li class="depth02_item">';
...
$(document).ready(function() {
    ...
    $(document).on("mouseenter focusin", ".header.gnb_pc .lnb_list .depth01", function () {
        ...
        $(".area_top, .area_top_inner p, .box_btns li, .box_btns .btn_zoom.in, .box_btns .btn_zoom.out, .box_btns .btn_zoom.reset, .area_menu, .area_menu, .lnb_list, .depth01, .depth01_item, .depth01_item_anchor, .area_menu .area_menu_inner .logo .logo_anchor, .area_top_inner").addClass("gnb_mouse_over");
    });
